      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Unified Overview</h1>
          </div>
          <p className="text-muted-foreground">
            Complete view of tasks across all your spaces
          </p>
        </div>
  ...
  useEffect(() => {
    async function loadSpaces() {
      try {
        ...
        if (data) {
          setSpaces(data.map(d => d.spaces).filter(Boolean));
        }
      } catch (error) {
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div 
                  className="w-4 w-4 rounded-full bg-blue-500"
                />
              </div>
            </CardHeader>
            <CardContent>

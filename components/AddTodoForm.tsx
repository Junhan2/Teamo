    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <Textarea
          ...
          rows={3}
          className="supertape-input text-base w-full resize-none"
        />
      </div>
      ...
      <div className="flex flex-col gap-3 w-full">
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className={cn(
                "w-full justify-start text-left font-normal button-ghost px-4 py-2 h-11 text-base",
          ...
          <PopoverContent className="w-auto p-0 glass-card border-[#2a2a3c]">
            <Calendar
              mode="single"
              selected={dueDate}
              onSelect={setDueDate}
              initialFocus
              className="bg-[#18181f] rounded-xl border-[#2a2a3c]"
            />
          </PopoverContent>
        </Popover>
        ...
        <Button 
          type="submit" 
          className="button-action w-full h-11 px-6 text-base"
          disabled={loading}
        >
      ...
      {message && (
        <div className={`p-2 text-xs rounded-xl ${
